                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-800/60">
                      @if (editingId()) {
                        @for (m of editingFamiliaMiembros(); track m.id) {
                          ...
                          <tr>
                            <td colspan="4" class="px-4 py-6 text-center text-xs text-slate-400 dark:text-slate-500 font-medium">
        ...
        <div class="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden" (click)="$event.stopPropagation()">
          ...
          <div class="flex items-center justify-between p-6 bg-emerald-600 dark:bg-emerald-700">
            <div>
              ...
              <p class="text-xs text-white font-medium mt-0.5">Información registrada del núcleo familiar.</p>
            </div>
            ...
            @if (viewFamilia()) {
              <div class="space-y-6">
                ...
                <div class="space-y-2">
                  ...
                  <div class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white font-medium">{{ viewFamilia()!.nombre }}</div>
                </div>

                <div class="space-y-2">
                  <label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[2px] ml-1">Dirección</label>
                  <div class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white font-medium">{{ viewFamilia()!.direccion }}</div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div class="space-y-2">
                    ...
                    <div class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white font-medium">{{ viewFamilia()!.consejo?.nombre ?? '---' }}</div>
                  </div>
                  <div class="space-y-2">
                    <label class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[2px] ml-1">Miembros</label>
                    <div class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white font-medium">{{ viewFamilia()!.miembros?.length ?? 0 }}</div>
                  </div>
                </div>
